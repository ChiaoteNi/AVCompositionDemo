//
//  CustomTransitionCompositionInstruction.swift
...
struct CustomTransitionLayerInstruction {
...
final class CustomTransitionCompositionInstruction: NSObject, AVVideoCompositionInstructionProtocol {

    var videoLayerInstructions: [CustomTransitionLayerInstruction]
    ...
    init(
        videoLayerInstructions: [CustomTransitionLayerInstruction],
